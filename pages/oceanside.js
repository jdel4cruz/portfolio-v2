...
const thoughtsText = [
  "This project was a great learning experience, but there’s quite a bit I would fix if I came back to it. Right off the bat, the general design of the application could use some work.",
  "At the time I built this website, I was still focused on just learning more tools and not so much focused on the design. Resizing some elements and adding some more contrast could go a long way. The general color scheme works though and with some adjustments, would look pretty good.",
  "More importantly though, I would add validation on both the front-end and back-end of the website.",
  "The lack of back-end validation is a serious issue if this website was actually taking user payments. There's no way I can be sure any information passed to my back-end from an external source is trustworthy, even if front-end validation is in place. All a user has to do is disable/modify my front-end validation code, or find a way to modify the request sent to the back-end. At that point, they'd be able to send me whatever information they would want.",
  "As an example, someone could place an order for 1,500 triple berry waffles for $12 and in it's current state, my back-end would receive it and automatically send the order to Stripe for processing.",
  " Of course in actuality this wouldn't fly because once someone at the cafe checks the order, they'll be extremely confused and the order probably won't be processed. But without having back-end validation in place to sanity check the requests received for processing, it's pretty easy to see how things can get out of hand.",
  "In addition, despite the ability for front-end validation to be bypassed, there's still a good purpose for it and that's for user feedback.",
  "Provided the user isn't trying anything malicious, they would like to have assurance that any information that they're providing for their purchase is valid. They want their triple berry waffles as much as you want to sell it to them. And if they were to provide invalid information and learned that their order wasn’t processed because of it, they’d be quite annoyed that there wasn’t anything to tell them what to fix prior to submitting their order.",
  "All in all though, it was a good learning experience. Unlike my previous project the PokeApp, this is a far more practical project in terms of what people could potentially employ me for.",
  "If you've read this far, thanks for taking the time to read the monster of an essay I just wrote and I hope you have a wonderful day!",
];
